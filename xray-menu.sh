...
EOF
    ...
    echo -e " TOTAL DAYS    : $duration Hari"
    echo -e " PORT          : $xtls"
    ...
    echo -e "============================================"
    echo -e " VLESS SPLICE  : vless://$uuid@$domain:$xtls?flow=xtls-rprx-splice&encryption=none&security=xtls&sni=$BUG&type=tcp&headerType=none&host=$BUG#$user"
    echo -e "============================================"
    echo -e " VLESS TLS WS  : vless://$uuid@$BUG.$domain:$xtls?encryption=none&security=tls&sni=$BUG&type=ws&host=$BUG&path=/xrayws#$user"
    echo -e "============================================"
    echo -e " TROJAN TLS    : trojan://$uuid@$BUG.$domain:$xtls?sni=$BUG#$user"
    echo -e "============================================"
    echo -e " VMESS TLS WS  : ${vmesslink1}"
    echo -e "============================================"
    echo ""
    read -n 1 -s -r -p "Press any key to back on menu"
    xray-menu   
