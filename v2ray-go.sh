...
EOF
cat <<EOF >/etc/rare/v2ray/conf/03_VLESS_NTLS_inbounds.json
{
  "log": {
...
END
EOF
cat <<EOF >/etc/rare/v2ray/conf/05_VMESS_NTLS_inbounds.json
{
  "log": {
    "access": "/var/log/xray/v2raynt-login.log",
    "error": "/var/log/xray/v2raynt-error.log",
    "loglevel": "info"
  },
  "inbounds": [
    {
